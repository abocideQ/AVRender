...
void gl3Plane::update_viewport(int width, int height) {
    m_r_width = width;
    m_r_height = height;
...
GLuint gl3Plane::gl_program_create(const char *vertex, const char *fragment) {
...
GLuint gl3Plane::gl_shader_create(GLenum gl_type, const char *gl_source) {
...
void gl3Plane::gl_check(int line) {
